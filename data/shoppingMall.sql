...
INSERT INTO MEMBER VALUES('KRISTAL','sss','������','����','1993/02/14','06234/���� ������ ������� 124/4��/(���ﵿ)','kristal@naver.com','01055861420',1);
INSERT INTO MEMBER VALUES('yun','asd','yun','����','95/04/01','12334/���� ������ ������� 124/4��/(���ﵿ)','yun@naver.com','01020893971',1);
INSERT INTO MEMBER VALUES('hong','asd','hong','����','90/01/01','06234/���� ������ ������� 124/4��/(���ﵿ)','hong@naver.com','01068755530',1);
INSERT INTO MEMBER VALUES('chang','asd','chang','����','88/07/07','06234/���� ������ ������� 124/4��/(���ﵿ)','chang@naver.com','01041643687',1);
INSERT INTO MEMBER VALUES('asd','asd','asdName','����',SYSDATE,'06234/���� ������ ������� 124/4��/(���ﵿ)','asd@asd.asd','01012341234',1);
INSERT INTO MEMBER VALUES('qwe','qwe','qweName','����',SYSDATE,'11111/���� ����/4��/(���ﵿ)','qwe@qwe.qwe','01012341234',1);
...
'고급스러운 소재를 자랑하며'||CHR(10)||CHR(13)||'원피스는 물론 팬츠나 스커트와도 잘 어울리는 상품입니다.'||CHR(10)||CHR(13)||
...
||CHR(10)||CHR(13)||'[COTTON 60% POLYESTER 40%]'
...
||CHR(10)||CHR(13)||'[COTTON 70% ACRYLIC 30%]'||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'
...
||CHR(10)||CHR(13)||'[COTTON 60% POLYESTER 40%]'||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'
||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY' ||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
'격식있는 자리에서 입기도 좋아 소장가치가 높은 상품입니다. ' ||CHR(10)||CHR(13)||'[WOOL 40% ACRYLIC 40% POLYESTER 20%]'
...
'원피스는 물론 다양한 코디에 매치하기 좋은 상품입니다.'||CHR(10)||CHR(13)||'[ACRYLIC 100%]'||CHR(10)||CHR(13)||
...
INSERT INTO PRODUCT VALUES(10,'Minimal crop knit vest',80100,'top','b24e98674d016cf112285106614bb945.jpg,d4818b73d6d716e73432643ac30302fa.jpg,bd1c232f011034780bfb0003479c3716.jpg,32a19ec6a2fc7a45a6a4a8b3c2731d32.jpg,8840baf286432fe0b7c53ac0f4426724.jpg,26e21364bcfadcb5ef39180d6aa80073.jpg','b24e98674d016cf112285106614bb945.jpg,d4818b73d6d716e73432643ac30302fa.jpg,bd1c232f011034780bfb0003479c3716.jpg,32a19ec6a2fc7a45a6a4a8b3c2731d32.jpg,8840baf286432fe0b7c53ac0f4426724.jpg,26e21364bcfadcb5ef39180d6aa80073.jpg','CREAM','MEDIUM,LARGE','센스있는 포인트가 되어줄 니트 베스트입니다.'||CHR(10)||CHR(13)||'미니멀한 기장감으로 트렌디함은 물론 한층 더 날씬해 보이는 효과를 주며,'
 ||CHR(10)||CHR(13)||'어떤 룩에나 포인트로 매치하기 좋아 소장가치가 높은 상품입니다.' ||CHR(10)||CHR(13)||
...
'크롭 기장감으로 썸머시즌 비치룩으로도 좋은 상품입니다.'||CHR(10)||CHR(13)||'[COTTON 100%]' ||CHR(10)||CHR(13)||
'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
||CHR(10)||CHR(13)||'팬츠는 물론 스커트와도 잘 어울리는 상품입니다.'||CHR(10)||CHR(13)||'[POLYESTER 100%]'
||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
'여성스러운 매력이 물씬 느껴지는 블라우스입니다.' ||CHR(10)||CHR(13)||'셔링과 퍼프소매 디테일이 포인트가 된 디자인으로'
||CHR(10)||CHR(13)||'팬츠는 물론 스커트와도 잘 어울리는 상품입니다.'||CHR(10)||CHR(13)||'[POLYESTER 100%]'||CHR(10)||CHR(13)||
'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
'팬츠는 물론 스커트와도 잘 어울리는 상품입니다.'||CHR(10)||CHR(13)||'[POLYESTER 100%]'||CHR(10)||CHR(13)||
'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY' ||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
'어디에나 매치하기 좋은 디자인의 데님 팬츠입니다.'||CHR(10)||CHR(13)||'여유 있는 핏감으로 사이즈에 구애 없이 즐길 수 있으며,'
 ||CHR(10)||CHR(13)||'편안한 착용감을 자랑해 데일리 아이템으로 제격인 상품입니다. ' ||CHR(10)||CHR(13)||
...
||CHR(10)||CHR(13)||'FABRIC : LINEN 100%'||CHR(10)||CHR(13)||'WASHING : DRY CLEANING ONLY'||CHR(10)||CHR(13)||'(두께 보통 / 신축성 없음 / 비침 보통 / 안감 없음 / 핏 보통)'
);
...
'가벼운 소재와 적당한 기장감으로'||CHR(10)||CHR(13)||'여름시즌 부담없이 즐기기 좋은 상품입니다.'||CHR(10)||CHR(13)||
'[COTTON 100%]'||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH'
);
...
'배색 디테일이 사랑스러운 분위기를 더한 상품입니다.'||CHR(10)||CHR(13)||'[RAYON 70% LINEN 16% COTTON 14%]'||CHR(10)||CHR(13)||
'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
||CHR(10)||CHR(13)||'[RAYON 66% NYLON 34%]' ||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||
'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
||CHR(10)||CHR(13)||'[POLYESTER 100%]'||CHR(10)||CHR(13)||'• DRY CLEAN ONLY'||CHR(10)||CHR(13)||
'• DO NOT TUMBLE DRY'||CHR(10)||CHR(13)||'• DO NOT BLEACH');
...
||CHR(10)||CHR(13)||'바디라인을 예쁘게 잡아주는 핏감으로 한층 더 슬림해 보이는 효과를 주는 제품입니다. ' ||CHR(10)||CHR(13)||
...
INSERT INTO NOTICE VALUES(1,'KRISTAL','�� ���� ���� ���� ���� �ȳ�','�� ���� ���� ���� ���� �ȳ�','2022/08/01',0);
INSERT INTO NOTICE VALUES(2,'KRISTAL','���� �Ϻ� ��ǰ�� ���� �Һ��� ������ ������� �ȳ��帳�ϴ�.','���� �Ϻ� ��ǰ�� ���� �Һ��� ������ ������� �ȳ��帳�ϴ�.','2022/08/03',0);
INSERT INTO NOTICE VALUES(3,'KRISTAL','���ͳ� �ͽ��÷η�(IE) ���� ���� �ȳ�','ģ�� �� ���� ���� ���� �ȳ�','2022/09/01',0);
INSERT INTO NOTICE VALUES(4,'KRISTAL','ģ�� �� ���� ���� ���� �ȳ�','ģ�� �� ���� ���� ���� �ȳ�','2022/09/20',0);
INSERT INTO NOTICE VALUES(5,'KRISTAL','�븮���� �̿� ������ ��ε帳�ϴ�.','�븮���� �̿� ������ ��ε帳�ϴ�.','2022/10/11',0);
INSERT INTO NOTICE VALUES(6,'KRISTAL','5���̻� �� ��� ������ �Ҹ� ���� ���������Դϴ�.','5���̻� �� ��� ������ �Ҹ� ���� ���������Դϴ�.','2022/11/27',0);
INSERT INTO NOTICE VALUES(7,'KRISTAL','[�����] �ļ� ��ġ�� ���� �����帳�ϴ�.','[�����] �ļ� ��ġ�� ���� �����帳�ϴ�.','2022/08/01',0);
INSERT INTO NOTICE VALUES(8,'KRISTAL','��ٱ��� ��ǰ ���� ��å ���� �ȳ�','��ٱ��� ��ǰ ���� ��å ���� �ȳ�','2022/12/25',0);


INSERT INTO QNA VALUES(1,'yun',1,'��ǰ����','��ǰ����','2022/08/01',0);
INSERT INTO QNA VALUES(2,'yun',2,'ȯ�ҹ���','ȯ�ҹ���','2022/08/02',0);
INSERT INTO QNA VALUES(3,'yun',3,'��������','��������','2022/08/03',0);
INSERT INTO QNA VALUES(4,'hong',1,'��ǰ����','��ǰ����','2022/08/04',0);
INSERT INTO QNA VALUES(5,'hong',2,'ȯ�ҹ���','ȯ�ҹ���','2022/08/05',0);
INSERT INTO QNA VALUES(6,'hong',3,'��������','��������','2022/08/06',0);
INSERT INTO QNA VALUES(7,'chang',1,'��ǰ����','��ǰ����','2022/08/07',0);
INSERT INTO QNA VALUES(8,'chang',2,'��������','��������','2022/08/08',0);


INSERT INTO REVIEW VALUES(1,'yun',1,'���� �̻���','���� �̻���','2022/08/01',0);
INSERT INTO REVIEW VALUES(2,'yun',2,'���','���','2022/08/02',0);
INSERT INTO REVIEW VALUES(3,'yun',3,'�ǻ� ����','�����մϴ�','2022/08/03',0);
INSERT INTO REVIEW VALUES(4,'hong',1,'�� ���;��','������ ������ �� �´°� ���ƿ�','2022/08/04',0);
INSERT INTO REVIEW VALUES(5,'hong',2,'�� �̿��ҰԿ�','�����մϴ�','2022/08/05',0);
INSERT INTO REVIEW VALUES(6,'hong',3,'������','���� �̻���','2022/08/06',0);
INSERT INTO REVIEW VALUES(7,'chang',1,'���� ������','�ǻ��;��','2022/08/07',0);
INSERT INTO REVIEW VALUES(8,'chang',2,'����','�ǻ�Կ�','2022/08/08',0);                            
