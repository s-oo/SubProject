...
INSERT INTO MEMBER VALUES('asd','asd','asdName','M',SYSDATE,'06234,¼­¿ï °­³²±¸ Å×Çì¶õ·Î 124,4Ãş,(¿ª»ïµ¿)','asd@asd.asd','01012341234');
INSERT INTO MEMBER VALUES('qwe','qwe','qweName','M',SYSDATE,'11111,¼­¿ï ¿ª»ï,4Ãş,(¿ª»ïµ¿)','qwe@qwe.qwe','01012341234');
...
INSERT INTO ORDERS VALUES(1,'asd',1,5,'red','L','cartList');
INSERT INTO ORDERS VALUES(2,'qwe',1,5,'red','L','cartList');
INSERT INTO ORDERS VALUES(3,'asd',3,5,'red','L','cartList');
INSERT INTO ORDERS VALUES(4,'qwe',2,3,'red','L','cartList');
INSERT INTO ORDERS VALUES(5,'asd',3,7,'red','L','wishList');

commit;

			select * from  (
			select rownum rnum,data.* from (
			SELECT ORDERNUM, USERID, O.PRODUCTNUM,ORDERQUANTITY, ORDERCOLOR, ORDERSIZE, PROGRESS, 
			PRODUCTNAME, PRODUCTPRICE, PRODUCTCATEGORY, SAVEFILENAME 
			FROM ORDERS O, PRODUCT P 
			WHERE O.PRODUCTNUM = P.PRODUCTNUM and PRODUCTNAME like '%s%' AND USERID = 'asd' AND PROGRESS = 'cartList' ORDER BY ORDERNUM DESC) data) 
